// qstd-helix HTTP app — liability-trade CRUD (FX, IRS, CCS) + Better Auth (Phase 2).
// Same shape as the Keystone app, scoped to liability products. Built from injected deps
...
const SYSTEM = "helix" as const;
const CreateTrade = makeCreateTradeSchema(HELIX_PRODUCTS);
