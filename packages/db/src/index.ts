// @qstd/db — Drizzle schema (PLAN §4 + Phase 2 auth tables), the Neon client, and
// the trades repository. Migrations are generated SQL under ./migrations; seed lives
// in ./src/seed.ts. `authSchema` exposes the per-system Better Auth tables for @qstd/auth.
